...
namespace XEx03Quotation
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        /// </summary>
        protected void CalculateForm()
        {
            if (this.ValidateForm())
            {
                float discountAmount = this.DiscountAmount;
                float total = this.GetTotal();
                lblDiscountAmount.Text = discountAmount.ToString();
                lblTotal.Text = total.ToString();

                Session["SalesPrice"] = this.SalesPrice;
        ...
        /// 
        /// This is done by calling <see cref="CalculateForm"/>.
        /// </summary>
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = "Please click the Calculate button before submitting.";
            } else
            {
